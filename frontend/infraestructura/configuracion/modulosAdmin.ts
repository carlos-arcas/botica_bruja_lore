export type ModuloNavegacionAdmin = {
  clave: "dashboard" | "productos" | "inventario" | "pedidos" | "rituales" | "editorial" | "secciones" | "importacion" | "imagenes" | "ajustes";
  href: string;
  etiqueta: string;
  descripcion?: string;
};
...
export const MODULOS_NAVEGACION_ADMIN: ModuloNavegacionAdmin[] = [
  ...
  { clave: "inventario", href: "/admin/inventario", etiqueta: "Inventario", descripcion: "Stock operativo y ajustes manuales trazables." },
