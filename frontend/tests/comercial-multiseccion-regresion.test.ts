...
const SECCIONES_COMERCIALES = [
  ...
  },
  {
    ...
    llamadaCatalogo: "obtenerProductosPublicosPorSeccion(VELAS_E_INCIENSO_PUBLICA.slug, filtros)",
    marcadorEntrada: "<PanelFiltrosBoticaNatural",
  },
  {
    ...
    llamadaCatalogo: "obtenerProductosPublicosPorSeccion(MINERALES_Y_ENERGIA_PUBLICA.slug, filtros)",
    marcadorEntrada: "<PanelFiltrosBoticaNatural",
  },
  {
    ...
    llamadaCatalogo: "obtenerProductosPublicosPorSeccion(HERRAMIENTAS_ESOTERICAS_PUBLICA.slug, filtros)",
    marcadorEntrada: "<PanelFiltrosBoticaNatural",
  },
] as const;
