...
export default async function AdminRitualesPage(): Promise<JSX.Element> {
  ...
  return <ModuloCrudAdmin modulo="rituales" titulo="Rituales" token={token} itemsIniciales={resultado.estado === "ok" ? resultado.items : []} campoEstado="publicado" plantilla={{ id: "", slug: "", nombre: "", contexto_breve: "", contenido: "", imagen_url: "", intenciones_relacionadas: "", publicado: false }} />;
}
