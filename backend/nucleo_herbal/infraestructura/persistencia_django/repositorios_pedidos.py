...
class RepositorioPedidosORM(RepositorioPedidos):
    ...
    def guardar(self, pedido: Pedido) -> Pedido:
        modelo, _ = PedidoRealModelo.objects.update_or_create(
            ...
            defaults={
                ...
                "email_cancelacion_enviado": pedido.email_cancelacion_enviado,
                "fecha_email_cancelacion": pedido.fecha_email_cancelacion,
                ...
                "email_reembolso_enviado": pedido.email_reembolso_enviado,
                "fecha_email_reembolso": pedido.fecha_email_reembolso,
    ...
    def _a_pedido(self, modelo: PedidoRealModelo) -> Pedido:
        return Pedido(
            ...
            email_cancelacion_enviado=modelo.email_cancelacion_enviado,
            fecha_email_cancelacion=modelo.fecha_email_cancelacion,
            ...
            email_reembolso_enviado=modelo.email_reembolso_enviado,
            fecha_email_reembolso=modelo.fecha_email_reembolso,
